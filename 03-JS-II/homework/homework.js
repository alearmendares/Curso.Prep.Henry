...
function esEntero(numero) {
  ...
  else if (Math.floor(numero) === 0) return false
  else return true
...
function fizzBuzz(numero) {
  ...
  var xresto3 = numero % 3
  var xresto5 = numero % 5
  if (xresto3 == 0 && xresto5 == 0 ) return "fizzbuzz";
  else if (xresto3 == 0) return "fizz";
      else if (xresto5 == 0) return "buzz";
        else return numero
}
...
if (numero < 2) return false
    ...
    for (var i = 2; i <= numero; i++) {
      ...
      else if (numero / i <= i) return true
